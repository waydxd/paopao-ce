...
## 0.6.0+dev ([`dev`](https://github.com/waydxd/paopao-ce/tree/dev))
TODO;
...
## 0.5.0
### Added
- add `LoggerOpenObserve` feature use OpenObserve to collect log.[#370](https://github.com/waydxd/paopao-ce/pull/370)    
  ...
  ...
  ```
- Added friend tweets bar feature support in home page. [#377](https://github.com/waydxd/paopao-ce/pull/377)    
...
## 0.4.2
### Fixed
- fixed remove multi-objects no effects and occurs resource leak error when use Minio as OSS(Object Storage System).[#371](https://github.com/waydxd/paopao-ce/pull/371) [#372](https://github.com/waydxd/paopao-ce/pull/372)  
...
## 0.4.0
### Added
- add `pprof` feature support [#327](https://github.com/waydxd/paopao-ce/pull/327)  
- use compiler profile-guided optimization (PGO) to further optimize builds. [#327](https://github.com/waydxd/paopao-ce/pull/327)  
- frontend: re-add stars page embed to  profile page. [#339](https://github.com/waydxd/paopao-ce/pull/339)  
- simple support for user posts filter by style(post/comment/media/star). [#345](https://github.com/waydxd/paopao-ce/pull/345)  
...
- add cli subcommand to start paopao-ce serve or other task. [#354](https://github.com/waydxd/paopao-ce/pull/354)  
...
### Changed
- change man content width to 600px and optimize tweet/comment/replay text length. [#333](https://github.com/waydxd/paopao-ce/pull/333) 
- optimize embed web ui to paopao execute binary file logic. [#354](https://github.com/waydxd/paopao-ce/pull/354)   
  ```sh
  ...
  ```
- frontend: optimize user profile page route path to domain/#/u/?s=username. [&c857142](https://github.com/waydxd/paopao-ce/commit/c857142565f0c28294344c7abc5c2df4e363b04c
- change the `Friendship` feature and `Followship` feature as builtin feature. [#362](https://github.com/waydxd/paopao-ce/pull/362)  
- deprecated/remove `Lightship` feature. [#362](https://github.com/waydxd/paopao-ce/pull/362)  
 - optimize Followship feature allow follow/unfollow user in follow page. [&fd5e54b](https://github.com/waydxd/paopao-ce/commit/fd5e54bd31108bb5a879d8b7afe0d2cbd56b3395)
- use Meilisearch as default search in docker-compose.yaml.

### Fixed
- fixed JWT valide error whent get user by id failed.[&51fd972](https://github.com/waydxd/paopao-ce/commit/51fd9724b96bbc8cc64405b36a5fd7ae69b7a52c)
  
## 0.3.1
### Fixed
- fixed: video player assets cdn error. [&caff8c0](https://github.com/waydxd/paopao-ce/commit/caff8c052be6c8d59576011192f830fd98e17ab3 'commit caff8c0')  

## 0.3.0
### Added

- add custom comment sort strategy support [#243](https://github.com/waydxd/paopao-ce/pull/243)
- add `RedisCacheIndex` feature [#250](https://github.com/waydxd/paopao-ce/pull/250)
- add `Sentry` feature [#258](https://github.com/waydxd/paopao-ce/pull/258)
- add simple tweet share feature(just copy tweet link to clipboard now) support [#264](https://github.com/waydxd/paopao-ce/pull/264)
- add default tweet max length configure in web/.env support. [&a1160ca](https://github.com/waydxd/paopao-ce/commit/a1160ca79380445157146d9eae1710543c153cce 'commit a1160ca')   
 Set the value of `VITE_DEFAULT_TWEET_MAX_LENGTH` in file web/.env to change the tweet max default length.
 - add custom whether provide user register configure in web/.env support. [#267](https://github.com/waydxd/paopao-ce/pull/267)   
    ...
    ...
    ```
- add topic follow feature support [#273](https://github.com/waydxd/paopao-ce/pull/273)   
  mirgration database first(sql ddl file in `scripts/migration/**/*_topic_follow.up.sql`):
    ...
    ```
- add tweet comment thumbs up/down feature support [#275](https://github.com/waydxd/paopao-ce/pull/275)   
  mirgration database first(sql ddl file in `scripts/migration/**/*_comment_thumbs.up.sql`):
- add load more comments feature support [&60b217b](https://github.com/waydxd/paopao-ce/commit/60b217bcd950c69ba45cebcaa17efdf8048d5a4f 'commit 60b217b')  

### Fixed

- fixed sql ddl p_contact's column `is_delete` define error (change to `is_del`) in scripts/paopao-mysql.sql [&afd8fe1](https://github.com/waydxd/paopao-ce/commit/afd8fe18d2dce08a4af846c2f822379d99a3d3b3 'commit afd8fe1')
- fixed cache index not expire in delete/add tweet error [#266](https://github.com/waydxd/paopao-ce/pull/266)
- fixed tweet's owner not allow star/collection action when tweet is private error [#274](https://github.com/waydxd/paopao-ce/pull/274)
- fixed user not list owner's collectioned private tweet error [#274](https://github.com/waydxd/paopao-ce/pull/274)
- fixed comments thumbs up/down state incorrect error [#283](https://github.com/waydxd/paopao-ce/pull/283)
...
- use [github.com/rueian/rueidis](https://github.com/rueian/rueidis) as Redis client [#249](https://github.com/waydxd/paopao-ce/pull/249)   
    ...
    ```
- optimize web frontend dark theme [&b082a8f](https://github.com/waydxd/paopao-ce/commit/b082a8fa5e43dd6dacf459df93fa7e243dd901ea 'commit b082a8f')
- change web frontend main content layout default size to 544px [&b082a8f](https://github.com/waydxd/paopao-ce/commit/b082a8fa5e43dd6dacf459df93fa7e243dd901ea 'commit b082a8f')
- optimize web frontend in mobile environment use Drawer to display menu [#265](https://github.com/waydxd/paopao-ce/pull/265)   
- optimize Dockerfile use pre-build builder/runner image to prevent network latency problem (`bitbus/paopao-ce-backend-builder` `bitbus/paopao-ce-backend-runner`) [#265](https://github.com/waydxd/paopao-ce/pull/265)  
- optimize web ui in mobile environment [#280](https://github.com/waydxd/paopao-ce/pull/280)  
- optimize upload zip attachment compatible with different browsers for uploading zip mimetype [#286](https://github.com/waydxd/paopao-ce/pull/286)  
- adapte meilisearch to version v1.1 [#288](https://github.com/waydxd/paopao-ce/pull/288)  

### Removed

- remove `Deprecated:OldWeb` feature  [#256](https://github.com/waydxd/paopao-ce/pull/256)   

## 0.2.5

### Changed

- fixed sql ddl error for contact table [#281](https://github.com/waydxd/paopao-ce/pull/281)

## 0.2.4

### Added

-  add PWA support for web frontend [#242](https://github.com/waydxd/paopao-ce/pull/242)
...
-  add PostgreSQL DDL file [#229](https://github.com/waydxd/paopao-ce/pull/229)

### Changed

- optimize MySQL DDL file [#229](https://github.com/waydxd/paopao-ce/pull/229)
- optimize Sqlite3 DDL file [#229](https://github.com/waydxd/paopao-ce/pull/229)

## 0.2.2

### Fixed

- fixed add star to tweet error [#222](https://github.com/waydxd/paopao-ce/pull/222)

## 0.2.1

### Changed

- optimize docker-compose.yaml use bitbus/paopao-ce:latest as release image [#217](https://github.com/waydxd/paopao-ce/pull/217)

### Fixed

- fixed sql ddl in scripts/paopao-mysql.sql and scripts/paopao-sqlite3.sql [#217](https://github.com/waydxd/paopao-ce/pull/217)

## 0.2.0

### Added

- add `Friendship` feature [#192](https://github.com/waydxd/paopao-ce/pull/192)
- add `Lightship` feature [#198](https://github.com/waydxd/paopao-ce/pull/198)
- add `Pyroscope` feature [#199](https://github.com/waydxd/paopao-ce/pull/199) 
- add new `Web` service [#196](https://github.com/waydxd/paopao-ce/pull/196)  
- add `Frontend:Web` feature [#196](https://github.com/waydxd/paopao-ce/pull/196)  
- add `Deprecated:OldWeb` feature [#196](https://github.com/waydxd/paopao-ce/pull/196)  

### Changes

- support run multiple service in single paopao-ce instance [#196](https://github.com/waydxd/paopao-ce/pull/196)  
- use [go-mir](https://github.com/alimy/mir) optimize paopao-ce source code architecture [#196](https://github.com/waydxd/paopao-ce/pull/196)  
...
**Older change logs can be found on [GitHub](https://github.com/waydxd/paopao-ce/releases?after=v0.2.0).**