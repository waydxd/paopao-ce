...
var file_core_v1_auth_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x42, 0x8a, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x72,
	0x65, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x41, 0x75, 0x74, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	0x01, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61,
	0x79, 0x64, 0x78, 0x64, 0x2f, 0x70, 0x61, 0x6f, 0x70, 0x61, 0x6f, 0x2d, 0x63, 0x65, 0x2f, 0x61,
	0x75, 0x74, 0x6f, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x3b,
...
func file_core_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_v1_auth_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_core_v1_auth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_core_v1_auth_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_core_v1_auth_proto_msgTypes[3].Exporter = func(v any, i int) any {
